...
package ws.billy.speedbuilderspractice.bungeecord.managers.versions.v1_14_R1;
...
public class GuardianManager implements ws.billy.speedbuilderspractice.bungeecord.managers.GuardianManager
{
    ...
    {
        public CustomGuardianElder(final EntityTypes<? extends EntityGuardianElder> entityTypes, final World world) {
        ...
        public static ElderGuardian spawnGuardian(final Location location) {
            ...
            final CustomGuardianElder customGuardianElder = new CustomGuardianElder((EntityTypes<? extends EntityGuardianElder>)EntityTypes.ELDER_GUARDIAN, (World)craftWorld.getHandle());
            ...
            craftWorld.getHandle().addEntity((net.minecraft.server.v1_14_R1.Entity)customGuardianElder, CreatureSpawnEvent.SpawnReason.CUSTOM);
