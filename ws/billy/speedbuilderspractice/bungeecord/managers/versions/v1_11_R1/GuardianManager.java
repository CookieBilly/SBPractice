...
package ws.billy.speedbuilderspractice.bungeecord.managers.versions.v1_11_R1;
...
public class GuardianManager implements ws.billy.speedbuilderspractice.bungeecord.managers.GuardianManager
{
    ...
    public void spawnGuardian() {
        ...
        new BukkitRunnable() {
            public void run() {
                GuardianManager.this.registerEntity("ElderGuardian", 4, (Class<? extends EntityInsentient>)CustomGuardianElder.class);
    ...
    public void registerEntity(final String s, final int n, final Class<? extends EntityInsentient> clazz) {
    ...
    private static class CustomGuardianElder extends EntityGuardianElder
    {
        ...
        public static ElderGuardian spawnGuardian(final Location location) {
            ...
            craftWorld.getHandle().addEntity((net.minecraft.server.v1_11_R1.Entity)customGuardianElder, CreatureSpawnEvent.SpawnReason.CUSTOM);
