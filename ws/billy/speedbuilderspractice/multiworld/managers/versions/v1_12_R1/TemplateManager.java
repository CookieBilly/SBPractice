...
package ws.billy.speedbuilderspractice.multiworld.managers.versions.v1_12_R1;
...
public class TemplateManager extends ws.billy.speedbuilderspractice.multiworld.managers.TemplateManager
{
                        ...
                        if (j != min2) {
                            ...
                            if (!state.getType().toString().equals("AIR")) {
                                if (state.getType().toString().equals("STANDING_BANNER") || state.getType().toString().equals("WALL_BANNER")) {
                                    if ((state.getType().toString() + ":" + (15 - ((Banner)state).getBaseColor().ordinal()) + ":" + state.getRawData()).equals(arena.getCurrentBuildBlocks().get(n))) {
                                    ...
                                    if ((state.getType().toString() + ":0:" + state.getRawData()).equals(arena.getCurrentBuildBlocks().get(n))) {
                                        hashMap.put(n, state.getType().toString() + ":0:" + state.getRawData());
                                    }
                                }
                                else if (state.getType().toString().equals("SKULL")) {
                                    if ((state.getType().toString() + ":" + ((Skull)state).getSkullType().ordinal() + ":" + state.getRawData() + ":" + ((Skull)state).getRotation().toString()).equals(arena.getCurrentBuildBlocks().get(n))) {
                                        hashMap.put(n, state.getType().toString() + ":" + ((Skull)state).getSkullType().ordinal() + ":" + state.getRawData() + ":" + ((Skull)state).getRotation().toString());
                                    }
                                }
                                else if ((state.getType().toString() + ":" + state.getRawData()).equals(arena.getCurrentBuildBlocks().get(n))) {
                ...
                for (int j = min; j <= max; ++j) {
                    for (int k = min2; k <= max2; ++k) {
                        for (int l = min3; l <= max3; ++l) {
                            final String string = this.plugin.getConfigManager().getConfig("templates.yml").getString("templates." + arena.getCurrentBuildRawName() + ".blocks." + i + ".type");
                            if (string.equals("STANDING_BANNER") || string.equals("WALL_BANNER")) {
                                final String[] split = this.plugin.getConfigManager().getConfig("templates.yml").getString("templates." + arena.getCurrentBuildRawName() + ".blocks." + i + ".data").split(":");
                                ...
                                final Banner banner = (Banner)Bukkit.getWorld(arena.getName()).getBlockAt(j, k, l).getState();
                                if (int1 == 0) {
                                ...
                                final byte byte2 = Byte.parseByte(this.plugin.getConfigManager().getConfig("templates.yml").getString("templates." + arena.getCurrentBuildRawName() + ".blocks." + i + ".data").split(":")[1]);
                                final BlockState state2 = Bukkit.getWorld(arena.getName()).getBlockAt(j, k, l).getState();
                                state2.setType(Material.getMaterial(string));
                                state2.setRawData(byte2);
                                state2.update(true, false);
                            }
                            else if (string.equals("SKULL")) {
                                final String[] split2 = this.plugin.getConfigManager().getConfig("templates.yml").getString("templates." + arena.getCurrentBuildRawName() + ".blocks." + i + ".data").split(":");
                                final int int2 = Integer.parseInt(split2[0]);
                                final byte byte3 = Byte.parseByte(split2[1]);
                                final String s3 = split2[2];
                                final BlockState state3 = Bukkit.getWorld(arena.getName()).getBlockAt(j, k, l).getState();
                                state3.setType(Material.getMaterial(string));
                                state3.setRawData(byte3);
                                state3.update(true, false);
                                final Skull skull = (Skull)Bukkit.getWorld(arena.getName()).getBlockAt(j, k, l).getState();
                                skull.setRotation(BlockFace.valueOf(s3));
                                if (int2 == 0) {
                                ...
                                final BlockState state4 = Bukkit.getWorld(arena.getName()).getBlockAt(j, k, l).getState();
                                state4.setType(Material.getMaterial(string));
                                state4.setRawData((byte)this.plugin.getConfigManager().getConfig("templates.yml").getInt("templates." + arena.getCurrentBuildRawName() + ".blocks." + i + ".data"));
                ...
                for (int n = min4; n <= max4; ++n) {
                    for (int n2 = min5; n2 <= max5; ++n2) {
                        for (int n3 = min6; n3 <= max6; ++n3) {
                            final String string2 = this.plugin.getConfigManager().getConfig("templates.yml").getString("templates." + arena.getCurrentBuildRawName() + ".blocks." + i2 + ".type");
                            if (string2.equals("STANDING_BANNER") || string2.equals("WALL_BANNER")) {
                                final String[] split3 = this.plugin.getConfigManager().getConfig("templates.yml").getString("templates." + arena.getCurrentBuildRawName() + ".blocks." + i2 + ".data").split(":");
                                final int int3 = Integer.parseInt(split3[0]);
                                final byte byte4 = Byte.parseByte(split3[1]);
                                final BlockState state5 = Bukkit.getWorld(arena.getName()).getBlockAt(n, n2, n3).getState();
                                state5.setType(Material.getMaterial(string2));
                                state5.setRawData(byte4);
                                state5.update(true, false);
                                final Banner banner2 = (Banner)Bukkit.getWorld(arena.getName()).getBlockAt(n, n2, n3).getState();
                                if (int3 == 0) {
                                ...
                                final byte byte5 = Byte.parseByte(this.plugin.getConfigManager().getConfig("templates.yml").getString("templates." + arena.getCurrentBuildRawName() + ".blocks." + i2 + ".data").split(":")[1]);
                                final BlockState state6 = Bukkit.getWorld(arena.getName()).getBlockAt(n, n2, n3).getState();
                                ...
                                final String[] split4 = this.plugin.getConfigManager().getConfig("templates.yml").getString("templates." + arena.getCurrentBuildRawName() + ".blocks." + i2 + ".data").split(":");
                                final int int4 = Integer.parseInt(split4[0]);
                                final byte byte6 = Byte.parseByte(split4[1]);
                                final String str = split4[2];
                                final BlockState state7 = Bukkit.getWorld(arena.getName()).getBlockAt(n, n2, n3).getState();
                                state7.setType(Material.getMaterial(string2));
                                state7.setRawData(byte6);
                                state7.update(true, false);
                                final Skull skull2 = (Skull)Bukkit.getWorld(arena.getName()).getBlockAt(n, n2, n3).getState();
                                ...
                                final String string3 = this.plugin.getConfigManager().getConfig("templates.yml").getString("templates." + arena.getCurrentBuildRawName() + ".blocks." + i2 + ".data");
                                final BlockState state8 = Bukkit.getWorld(arena.getName()).getBlockAt(n, n2, n3).getState();
    ...
    public void unloadTemplate(final String str, final String s) {
        ...
        if (arena != null) {
            if (str.equalsIgnoreCase("guardian")) {
                for (final String s2 : this.plugin.getConfigManager().getConfig("arenas.yml").getConfigurationSection("arenas." + arena.getName() + ".plots.guardian.blocks").getKeys(false)) {
                    final String[] split = s2.split(",");
                    final String string = this.plugin.getConfigManager().getConfig("arenas.yml").getString("arenas." + arena.getName() + ".plots.guardian.blocks." + s2 + ".type");
                    ...
                    state.setType(Material.getMaterial(string));
                    state.setRawData((byte)this.plugin.getConfigManager().getConfig("arenas.yml").getInt("arenas." + arena.getName() + ".plots.guardian.blocks." + s2 + ".data"));
                    state.update(true, false);
                }
            }
            else {
    ...
    public void resetPlots(final String s) {
        ...
        if (arena != null && this.plugin.getConfigManager().getConfig("arenas.yml").contains("arenas." + arena.getName() + ".plots")) {
            for (final String s2 : this.plugin.getConfigManager().getConfig("arenas.yml").getConfigurationSection("arenas." + arena.getName() + ".plots").getKeys(false)) {
                if (this.plugin.getConfigManager().getConfig("arenas.yml").contains("arenas." + arena.getName() + ".plots." + s2 + ".blocks")) {
                    for (final String s3 : this.plugin.getConfigManager().getConfig("arenas.yml").getConfigurationSection("arenas." + arena.getName() + ".plots." + s2 + ".blocks").getKeys(false)) {
                        final String[] split = s3.split(",");
                        final String string = this.plugin.getConfigManager().getConfig("arenas.yml").getString("arenas." + arena.getName() + ".plots." + s2 + ".blocks." + s3 + ".type");
                        final BlockState state = Bukkit.getWorld(arena.getName()).getBlockAt(Integer.parseInt(split[0]), Integer.parseInt(split[1]), Integer.parseInt(split[2])).getState();
                        state.setType(Material.getMaterial(string));
                        state.setRawData((byte)this.plugin.getConfigManager().getConfig("arenas.yml").getInt("arenas." + arena.getName() + ".plots." + s2 + ".blocks." + s3 + ".data"));
                        state.update(true, false);
                    }
                }
            }
    ...
    public void savePlots(final String s) {
        ...
        if (arena != null) {
            for (final String str : this.plugin.getConfigManager().getConfig("arenas.yml").getConfigurationSection("arenas." + arena.getName() + ".plots").getKeys(false)) {
                this.plugin.getConfigManager().getConfig("arenas.yml").set("arenas." + arena.getName() + ".plots." + str + ".blocks", (Object)"");
                if (str.equalsIgnoreCase("guardian")) {
                    final int min = Math.min(this.plugin.getConfigManager().getConfig("arenas.yml").getInt("arenas." + arena.getName() + ".plots.guardian.template-area.x1"), this.plugin.getConfigManager().getConfig("arenas.yml").getInt("arenas." + arena.getName() + ".plots.guardian.template-area.x2"));
                    final int min2 = Math.min(this.plugin.getConfigManager().getConfig("arenas.yml").getInt("arenas." + arena.getName() + ".plots.guardian.template-area.y1"), this.plugin.getConfigManager().getConfig("arenas.yml").getInt("arenas." + arena.getName() + ".plots.guardian.template-area.y2"));
                    final int min3 = Math.min(this.plugin.getConfigManager().getConfig("arenas.yml").getInt("arenas." + arena.getName() + ".plots.guardian.template-area.z1"), this.plugin.getConfigManager().getConfig("arenas.yml").getInt("arenas." + arena.getName() + ".plots.guardian.template-area.z2"));
                    ...
                    for (int i = min; i <= max; ++i) {
                        for (int j = min2; j <= max2; ++j) {
                            for (int k = min3; k <= max3; ++k) {
                                final BlockState state = Bukkit.getWorld(arena.getName()).getBlockAt(i, j, k).getState();
                                if (state.getType().toString().equals("STANDING_BANNER") || state.getType().toString().equals("WALL_BANNER")) {
                                    this.plugin.getConfigManager().getConfig("arenas.yml").set("arenas." + arena.getName() + ".plots.guardian.blocks." + i + "," + j + "," + k + ".type", (Object)state.getType().toString());
                                    this.plugin.getConfigManager().getConfig("arenas.yml").set("arenas." + arena.getName() + ".plots.guardian.blocks." + i + "," + j + "," + k + ".data", (Object)(15 - ((Banner)state).getBaseColor().ordinal() + ":" + state.getRawData()));
                                }
                                else if (state.getType().toString().equals("BED_BLOCK")) {
                                    this.plugin.getConfigManager().getConfig("arenas.yml").set("arenas." + arena.getName() + ".plots.guardian.blocks." + i + "," + j + "," + k + ".type", (Object)state.getType().toString());
                                    this.plugin.getConfigManager().getConfig("arenas.yml").set("arenas." + arena.getName() + ".plots.guardian.blocks." + i + "," + j + "," + k + ".data", (Object)("0:" + state.getRawData()));
                                }
                                else if (state.getType().toString().equals("SKULL")) {
                                    this.plugin.getConfigManager().getConfig("arenas.yml").set("arenas." + arena.getName() + ".plots.guardian.blocks." + i + "," + j + "," + k + ".type", (Object)state.getType().toString());
                                    this.plugin.getConfigManager().getConfig("arenas.yml").set("arenas." + arena.getName() + ".plots.guardian.blocks." + i + "," + j + "," + k + ".data", (Object)(((Skull)state).getSkullType().ordinal() + ":" + state.getRawData() + ":" + ((Skull)state).getRotation().toString()));
                                }
                                else {
                                    this.plugin.getConfigManager().getConfig("arenas.yml").set("arenas." + arena.getName() + ".plots.guardian.blocks." + i + "," + j + "," + k + ".type", (Object)state.getType().toString());
                                    this.plugin.getConfigManager().getConfig("arenas.yml").set("arenas." + arena.getName() + ".plots.guardian.blocks." + i + "," + j + "," + k + ".data", (Object)state.getRawData());
                                }
                            }
                        }
                    }
                    ...
                    final int min4 = Math.min(this.plugin.getConfigManager().getConfig("arenas.yml").getInt("arenas." + arena.getName() + ".plots." + str + ".area.x1"), this.plugin.getConfigManager().getConfig("arenas.yml").getInt("arenas." + arena.getName() + ".plots." + str + ".area.x2"));
                    final int min5 = Math.min(this.plugin.getConfigManager().getConfig("arenas.yml").getInt("arenas." + arena.getName() + ".plots." + str + ".area.y1"), this.plugin.getConfigManager().getConfig("arenas.yml").getInt("arenas." + arena.getName() + ".plots." + str + ".area.y2"));
                    final int min6 = Math.min(this.plugin.getConfigManager().getConfig("arenas.yml").getInt("arenas." + arena.getName() + ".plots." + str + ".area.z1"), this.plugin.getConfigManager().getConfig("arenas.yml").getInt("arenas." + arena.getName() + ".plots." + str + ".area.z2"));
                    final int max4 = Math.max(this.plugin.getConfigManager().getConfig("arenas.yml").getInt("arenas." + arena.getName() + ".plots." + str + ".area.x1"), this.plugin.getConfigManager().getConfig("arenas.yml").getInt("arenas." + arena.getName() + ".plots." + str + ".area.x2"));
                    final int max5 = Math.max(this.plugin.getConfigManager().getConfig("arenas.yml").getInt("arenas." + arena.getName() + ".plots." + str + ".area.y1"), this.plugin.getConfigManager().getConfig("arenas.yml").getInt("arenas." + arena.getName() + ".plots." + str + ".area.y2"));
                    final int max6 = Math.max(this.plugin.getConfigManager().getConfig("arenas.yml").getInt("arenas." + arena.getName() + ".plots." + str + ".area.z1"), this.plugin.getConfigManager().getConfig("arenas.yml").getInt("arenas." + arena.getName() + ".plots." + str + ".area.z2"));
                    for (int l = min4; l <= max4; ++l) {
                        for (int n = min5; n <= max5; ++n) {
                            for (int n2 = min6; n2 <= max6; ++n2) {
                                final BlockState state2 = Bukkit.getWorld(arena.getName()).getBlockAt(l, n, n2).getState();
                                if (state2.getType().toString().equals("STANDING_BANNER") || state2.getType().toString().equals("WALL_BANNER")) {
                                    this.plugin.getConfigManager().getConfig("arenas.yml").set("arenas." + arena.getName() + ".plots." + str + ".blocks." + l + "," + n + "," + n2 + ".type", (Object)state2.getType().toString());
                                    this.plugin.getConfigManager().getConfig("arenas.yml").set("arenas." + arena.getName() + ".plots." + str + ".blocks." + l + "," + n + "," + n2 + ".data", (Object)(15 - ((Banner)state2).getBaseColor().ordinal() + ":" + state2.getRawData()));
                                }
                                else if (state2.getType().toString().equals("BED_BLOCK")) {
                                    this.plugin.getConfigManager().getConfig("arenas.yml").set("arenas." + arena.getName() + ".plots." + str + ".blocks." + l + "," + n + "," + n2 + ".type", (Object)state2.getType().toString());
                                    this.plugin.getConfigManager().getConfig("arenas.yml").set("arenas." + arena.getName() + ".plots." + str + ".blocks." + l + "," + n + "," + n2 + ".data", (Object)("0:" + state2.getRawData()));
                                }
                                else if (state2.getType().toString().equals("SKULL")) {
                                    this.plugin.getConfigManager().getConfig("arenas.yml").set("arenas." + arena.getName() + ".plots." + str + ".blocks." + l + "," + n + "," + n2 + ".type", (Object)state2.getType().toString());
                                    this.plugin.getConfigManager().getConfig("arenas.yml").set("arenas." + arena.getName() + ".plots." + str + ".blocks." + l + "," + n + "," + n2 + ".data", (Object)(((Skull)state2).getSkullType().ordinal() + ":" + state2.getRawData() + ":" + ((Skull)state2).getRotation().toString()));
                                }
                                else {
                                    this.plugin.getConfigManager().getConfig("arenas.yml").set("arenas." + arena.getName() + ".plots." + str + ".blocks." + l + "," + n + "," + n2 + ".type", (Object)state2.getType().toString());
                                    this.plugin.getConfigManager().getConfig("arenas.yml").set("arenas." + arena.getName() + ".plots." + str + ".blocks." + l + "," + n + "," + n2 + ".data", (Object)state2.getRawData());
                                }
                            }
                        }
                    }
