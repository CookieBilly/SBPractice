...
public class NMSManager implements ws.billy.speedbuilderspractice.bungeecord.managers.NMSManager
{
    ...
    public void showActionBar(final Player player, final String s) {
        ((CraftPlayer)player).getHandle().playerConnection.sendPacket((Packet)new PacketPlayOutChat(IChatBaseComponent.ChatSerializer.a("{\"text\": \"" + ChatColor.translateAlternateColorCodes('&', s) + "\"}"), ChatMessageType.GAME_INFO));
    }
