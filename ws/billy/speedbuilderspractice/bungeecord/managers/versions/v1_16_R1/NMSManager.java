...
package ws.billy.speedbuilderspractice.bungeecord.managers.versions.v1_16_R1;
...
public class NMSManager implements ws.billy.speedbuilderspractice.bungeecord.managers.NMSManager
{
    ...
    public void showTitle(final Player player, final int n, final int n2, final int n3, final String s, final String s2) {
        ...
        if (s != null) {
            ((CraftPlayer)player).getHandle().playerConnection.sendPacket((Packet)new PacketPlayOutTitle(PacketPlayOutTitle.EnumTitleAction.TITLE, (IChatBaseComponent)IChatBaseComponent.ChatSerializer.a("{\"text\": \"" + ChatColor.translateAlternateColorCodes('&', s) + "\"}")));
        }
        if (s2 != null) {
            ((CraftPlayer)player).getHandle().playerConnection.sendPacket((Packet)new PacketPlayOutTitle(PacketPlayOutTitle.EnumTitleAction.SUBTITLE, (IChatBaseComponent)IChatBaseComponent.ChatSerializer.a("{\"text\": \"" + ChatColor.translateAlternateColorCodes('&', s2) + "\"}")));
        }
    }
    ...
    public DataWatcher setGuardianTarget(final Guardian guardian, final int i) {
        ...
        dataWatcher.set(new DataWatcherObject(16, DataWatcherRegistry.b), (Object)i);
        return dataWatcher;
    }
