...
package ws.billy.speedbuilderspractice.multiworld.managers.versions.v1_13_R2;
        ...
        if (blockBreakEvent.getBlock().getState() instanceof Sign) {
            ...
            if (sign.getLine(0).equals(ChatColor.translateAlternateColorCodes('&', Translations.translate("PREFIX-SIGN")))) {
                if (player.hasPermission("sb.command.setup")) {
                    if (this.plugin.getConfigManager().getConfig("signs.yml").contains("signs." + sign.getBlock().getX() + "," + sign.getBlock().getY() + "," + sign.getBlock().getZ())) {
                        if (sign.getBlockData() instanceof org.bukkit.block.data.type.Sign) {
                            blockBreakEvent.getBlock().getRelative(BlockFace.DOWN).setType(Material.getMaterial(this.plugin.getConfigManager().getConfig("signs.yml").getString("signs." + sign.getBlock().getX() + "," + sign.getBlock().getY() + "," + sign.getBlock().getZ() + ".previous-type")));
                            ...
                            blockBreakEvent.getBlock().getRelative(((WallSign)sign.getBlockData()).getFacing().getOppositeFace()).setType(Material.getMaterial(this.plugin.getConfigManager().getConfig("signs.yml").getString("signs." + sign.getBlock().getX() + "," + sign.getBlock().getY() + "," + sign.getBlock().getZ() + ".previous-type")));
                            this.plugin.getConfigManager().getConfig("signs.yml").set("signs." + sign.getBlock().getX() + "," + sign.getBlock().getY() + "," + sign.getBlock().getZ(), (Object)null);
                            new BukkitRunnable() {
                                public void run() {
                                    SignManager.this.plugin.getConfigManager().saveConfig("signs.yml");
            ...
            else if (block.getRelative(BlockFace.NORTH).getState().getBlockData() instanceof WallSign) {
                final Sign sign2 = (Sign)block.getRelative(BlockFace.NORTH).getState();
                if (((WallSign)sign2.getBlockData()).getFacing().getOppositeFace() == block.getRelative(BlockFace.NORTH).getFace(block) && sign2.getLine(0).equalsIgnoreCase(ChatColor.translateAlternateColorCodes('&', Translations.translate("PREFIX-SIGN")))) {
                    blockBreakEvent.setCancelled(true);
                }
            }
            else if (block.getRelative(BlockFace.SOUTH).getState().getBlockData() instanceof WallSign) {
                final Sign sign3 = (Sign)block.getRelative(BlockFace.SOUTH).getState();
                if (((WallSign)sign3.getBlockData()).getFacing().getOppositeFace() == block.getRelative(BlockFace.SOUTH).getFace(block) && sign3.getLine(0).equalsIgnoreCase(ChatColor.translateAlternateColorCodes('&', Translations.translate("PREFIX-SIGN")))) {
                    blockBreakEvent.setCancelled(true);
                }
            }
            else if (block.getRelative(BlockFace.EAST).getState().getBlockData() instanceof WallSign) {
                final Sign sign4 = (Sign)block.getRelative(BlockFace.EAST).getState();
                if (((WallSign)sign4.getBlockData()).getFacing().getOppositeFace() == block.getRelative(BlockFace.EAST).getFace(block) && sign4.getLine(0).equalsIgnoreCase(ChatColor.translateAlternateColorCodes('&', Translations.translate("PREFIX-SIGN")))) {
                    blockBreakEvent.setCancelled(true);
                }
            }
            else if (block.getRelative(BlockFace.WEST).getState().getBlockData() instanceof WallSign) {
                final Sign sign5 = (Sign)block.getRelative(BlockFace.WEST).getState();
                if (((WallSign)sign5.getBlockData()).getFacing().getOppositeFace() == block.getRelative(BlockFace.WEST).getFace(block) && sign5.getLine(0).equalsIgnoreCase(ChatColor.translateAlternateColorCodes('&', Translations.translate("PREFIX-SIGN")))) {
                    blockBreakEvent.setCancelled(true);
                }
            }
        }
        ...
        if (signChangeEvent.getLine(0).equalsIgnoreCase("[SB]") || signChangeEvent.getLine(0).equalsIgnoreCase("[SpeedBuilders]")) {
            if (player.hasPermission("sb.command.setup")) {
                ...
                if (signChangeEvent.getLine(1).equalsIgnoreCase("[AutoJoin]")) {
                    if (sign.getBlockData() instanceof org.bukkit.block.data.type.Sign) {
                        final Block relative = sign.getBlock().getRelative(BlockFace.DOWN);
                        ...
                        this.plugin.getConfigManager().getConfig("signs.yml").set("signs." + sign.getBlock().getX() + "," + sign.getBlock().getY() + "," + sign.getBlock().getZ() + ".previous-type", (Object)relative.getType().toString());
                        new BukkitRunnable() {
                            public void run() {
                                SignManager.this.plugin.getConfigManager().saveConfig("signs.yml");
                            }
                        ...
                        final Block relative2 = sign.getBlock().getRelative(((WallSign)sign.getBlockData()).getFacing().getOppositeFace());
                        this.plugin.getConfigManager().getConfig("signs.yml").set("signs." + sign.getBlock().getX() + "," + sign.getBlock().getY() + "," + sign.getBlock().getZ() + ".world", (Object)sign.getWorld().getName());
                        this.plugin.getConfigManager().getConfig("signs.yml").set("signs." + sign.getBlock().getX() + "," + sign.getBlock().getY() + "," + sign.getBlock().getZ() + ".previous-type", (Object)relative2.getType().toString());
                        new BukkitRunnable() {
                            public void run() {
                                SignManager.this.plugin.getConfigManager().saveConfig("signs.yml");
                            }
                    ...
                    if (sign.getBlockData() instanceof org.bukkit.block.data.type.Sign) {
                        final Block relative3 = sign.getBlock().getRelative(BlockFace.DOWN);
                        this.plugin.getConfigManager().getConfig("signs.yml").set("signs." + sign.getBlock().getX() + "," + sign.getBlock().getY() + "," + sign.getBlock().getZ() + ".world", (Object)sign.getWorld().getName());
                        this.plugin.getConfigManager().getConfig("signs.yml").set("signs." + sign.getBlock().getX() + "," + sign.getBlock().getY() + "," + sign.getBlock().getZ() + ".previous-type", (Object)relative3.getType().toString());
                        new BukkitRunnable() {
                            public void run() {
                                SignManager.this.plugin.getConfigManager().saveConfig("signs.yml");
                            }
                        ...
                        final Block relative4 = sign.getBlock().getRelative(((WallSign)sign.getBlockData()).getFacing().getOppositeFace());
                        this.plugin.getConfigManager().getConfig("signs.yml").set("signs." + sign.getBlock().getX() + "," + sign.getBlock().getY() + "," + sign.getBlock().getZ() + ".world", (Object)sign.getWorld().getName());
                        this.plugin.getConfigManager().getConfig("signs.yml").set("signs." + sign.getBlock().getX() + "," + sign.getBlock().getY() + "," + sign.getBlock().getZ() + ".previous-type", (Object)relative4.getType().toString());
                        new BukkitRunnable() {
                            public void run() {
                                SignManager.this.plugin.getConfigManager().saveConfig("signs.yml");
                            }
                    ...
                    if (sign.getBlockData() instanceof org.bukkit.block.data.type.Sign) {
                        final Block relative5 = sign.getBlock().getRelative(BlockFace.DOWN);
                        this.plugin.getConfigManager().getConfig("signs.yml").set("signs." + sign.getBlock().getX() + "," + sign.getBlock().getY() + "," + sign.getBlock().getZ() + ".world", (Object)sign.getWorld().getName());
                        this.plugin.getConfigManager().getConfig("signs.yml").set("signs." + sign.getBlock().getX() + "," + sign.getBlock().getY() + "," + sign.getBlock().getZ() + ".previous-type", (Object)relative5.getType().toString());
                        new BukkitRunnable() {
                            public void run() {
                                SignManager.this.plugin.getConfigManager().saveConfig("signs.yml");
                            }
                        ...
                        final Block relative6 = sign.getBlock().getRelative(((WallSign)sign.getBlockData()).getFacing().getOppositeFace());
                        this.plugin.getConfigManager().getConfig("signs.yml").set("signs." + sign.getBlock().getX() + "," + sign.getBlock().getY() + "," + sign.getBlock().getZ() + ".world", (Object)sign.getWorld().getName());
                        this.plugin.getConfigManager().getConfig("signs.yml").set("signs." + sign.getBlock().getX() + "," + sign.getBlock().getY() + "," + sign.getBlock().getZ() + ".previous-type", (Object)relative6.getType().toString());
                        new BukkitRunnable() {
                            public void run() {
                                SignManager.this.plugin.getConfigManager().saveConfig("signs.yml");
                            }
                    ...
                    if (sign.getBlockData() instanceof org.bukkit.block.data.type.Sign) {
                        final Block relative7 = sign.getBlock().getRelative(BlockFace.DOWN);
                        ...
                        this.plugin.getConfigManager().getConfig("signs.yml").set("signs." + sign.getBlock().getX() + "," + sign.getBlock().getY() + "," + sign.getBlock().getZ() + ".world", (Object)sign.getWorld().getName());
                        this.plugin.getConfigManager().getConfig("signs.yml").set("signs." + sign.getBlock().getX() + "," + sign.getBlock().getY() + "," + sign.getBlock().getZ() + ".previous-type", (Object)relative7.getType().toString());
                        new BukkitRunnable() {
                            public void run() {
                                SignManager.this.plugin.getConfigManager().saveConfig("signs.yml");
                            }
                        ...
                        if (arena.getGameState() == GameState.WAITING) {
                            ...
                            relative7.setType(Materials.LIME_TERRACOTTA.getType("block"));
                        }
                            ...
                            relative7.setType(Materials.ORANGE_TERRACOTTA.getType("block"));
                        }
                            ...
                            relative7.setType(Materials.RED_TERRACOTTA.getType("block"));
                        }
                        ...
                        final Block relative8 = sign.getBlock().getRelative(((WallSign)sign.getBlockData()).getFacing().getOppositeFace());
                        this.plugin.getConfigManager().getConfig("signs.yml").set("signs." + sign.getBlock().getX() + "," + sign.getBlock().getY() + "," + sign.getBlock().getZ() + ".arena", (Object)signChangeEvent.getLine(1));
                        this.plugin.getConfigManager().getConfig("signs.yml").set("signs." + sign.getBlock().getX() + "," + sign.getBlock().getY() + "," + sign.getBlock().getZ() + ".world", (Object)sign.getWorld().getName());
                        this.plugin.getConfigManager().getConfig("signs.yml").set("signs." + sign.getBlock().getX() + "," + sign.getBlock().getY() + "," + sign.getBlock().getZ() + ".previous-type", (Object)relative8.getType().toString());
                        new BukkitRunnable() {
                            public void run() {
                                SignManager.this.plugin.getConfigManager().saveConfig("signs.yml");
                            }
                        }.runTaskAsynchronously((Plugin)this.plugin);
                        final Arena arena2 = this.plugin.getMultiWorld().getArenaManager().getArena(signChangeEvent.getLine(1));
                        signChangeEvent.setLine(1, arena2.getName());
                        if (arena2.getGameState() == GameState.WAITING) {
                            signChangeEvent.setLine(2, ChatColor.translateAlternateColorCodes('&', Translations.translate("GAMESTATE-WAITING")));
                            relative8.setType(Materials.LIME_TERRACOTTA.getType("block"));
                        }
                        else if (arena2.getGameState() == GameState.STARTING) {
                            signChangeEvent.setLine(2, ChatColor.translateAlternateColorCodes('&', Translations.translate("GAMESTATE-STARTING")));
                            relative8.setType(Materials.ORANGE_TERRACOTTA.getType("block"));
                        }
                        else if (arena2.getGameState() == GameState.GAME_STARTING) {
                            signChangeEvent.setLine(2, ChatColor.translateAlternateColorCodes('&', Translations.translate("GAMESTATE-GAME_STARTING")));
                            relative8.setType(Materials.RED_TERRACOTTA.getType("block"));
                        }
                        else if (arena2.getGameState() == GameState.SHOWCASING) {
                            signChangeEvent.setLine(2, ChatColor.translateAlternateColorCodes('&', Translations.translate("GAMESTATE-SHOWCASING")));
                            relative8.setType(Materials.RED_TERRACOTTA.getType("block"));
                        }
                        else if (arena2.getGameState() == GameState.BUILDING) {
                            signChangeEvent.setLine(2, ChatColor.translateAlternateColorCodes('&', Translations.translate("GAMESTATE-BUILDING")));
                            relative8.setType(Materials.RED_TERRACOTTA.getType("block"));
                        }
                        else if (arena2.getGameState() == GameState.JUDGING) {
                            signChangeEvent.setLine(2, ChatColor.translateAlternateColorCodes('&', Translations.translate("GAMESTATE-JUDGING")));
                            relative8.setType(Materials.RED_TERRACOTTA.getType("block"));
                        }
                        signChangeEvent.setLine(3, arena2.getPlayers().size() + "/" + arena2.getMaxPlayers());
                        player.sendMessage(ChatColor.translateAlternateColorCodes('&', Translations.translate("PREFIX-CHAT") + "&7SpeedBuilders sign is successfully created!"));
                    }
                }
                else {
            ...
            if (this.plugin.getConfigManager().getConfig("signs.yml").contains("signs." + split[0] + "," + split[1] + "," + split[2]) && this.plugin.getConfigManager().getConfig("signs.yml").getString("signs." + split[0] + "," + split[1] + "," + split[2] + ".arena").equals(anObject)) {
                ...
                if (state.getBlockData() instanceof org.bukkit.block.data.type.Sign) {
                    ...
                    if (arena.getGameState() == GameState.WAITING) {
                        ...
                        block.getRelative(BlockFace.DOWN).setType(Materials.LIME_TERRACOTTA.getType("block"));
                    }
                    else if (arena.getGameState() == GameState.STARTING) {
                        sign.setLine(2, ChatColor.translateAlternateColorCodes('&', Translations.translate("GAMESTATE-STARTING")));
                        block.getRelative(BlockFace.DOWN).setType(Materials.ORANGE_TERRACOTTA.getType("block"));
                    }
                    else if (arena.getGameState() == GameState.GAME_STARTING) {
                        sign.setLine(2, ChatColor.translateAlternateColorCodes('&', Translations.translate("GAMESTATE-GAME_STARTING")));
                        block.getRelative(BlockFace.DOWN).setType(Materials.RED_TERRACOTTA.getType("block"));
                    }
                    else if (arena.getGameState() == GameState.SHOWCASING) {
                        ...
                        block.getRelative(BlockFace.DOWN).getState().setType(Materials.RED_TERRACOTTA.getType("block"));
                    }
                    else if (arena.getGameState() == GameState.JUDGING) {
                    ...
                    final Sign sign2 = (Sign)state;
                    final WallSign wallSign = (WallSign)state.getBlockData();
                    sign2.setLine(0, ChatColor.translateAlternateColorCodes('&', Translations.translate("PREFIX-SIGN")));
                    sign2.setLine(1, arena.getName());
                    if (arena.getGameState() == GameState.WAITING) {
                        sign2.setLine(2, ChatColor.translateAlternateColorCodes('&', Translations.translate("GAMESTATE-WAITING")));
                        block.getRelative(wallSign.getFacing().getOppositeFace()).setType(Materials.LIME_TERRACOTTA.getType("block"));
                    }
                    else if (arena.getGameState() == GameState.STARTING) {
                        sign2.setLine(2, ChatColor.translateAlternateColorCodes('&', Translations.translate("GAMESTATE-STARTING")));
                        block.getRelative(wallSign.getFacing().getOppositeFace()).setType(Materials.ORANGE_TERRACOTTA.getType("block"));
                    }
                    else if (arena.getGameState() == GameState.GAME_STARTING) {
                        sign2.setLine(2, ChatColor.translateAlternateColorCodes('&', Translations.translate("GAMESTATE-GAME_STARTING")));
                        block.getRelative(wallSign.getFacing().getOppositeFace()).setType(Materials.RED_TERRACOTTA.getType("block"));
                    }
                    else if (arena.getGameState() == GameState.SHOWCASING) {
                        sign2.setLine(2, ChatColor.translateAlternateColorCodes('&', Translations.translate("GAMESTATE-SHOWCASING")));
                        block.getRelative(wallSign.getFacing().getOppositeFace()).setType(Materials.RED_TERRACOTTA.getType("block"));
                    }
                    else if (arena.getGameState() == GameState.BUILDING) {
                        sign2.setLine(2, ChatColor.translateAlternateColorCodes('&', Translations.translate("GAMESTATE-BUILDING")));
                        block.getRelative(wallSign.getFacing().getOppositeFace()).setType(Materials.RED_TERRACOTTA.getType("block"));
                    }
                    else if (arena.getGameState() == GameState.JUDGING) {
                        sign2.setLine(2, ChatColor.translateAlternateColorCodes('&', Translations.translate("GAMESTATE-JUDGING")));
                        block.getRelative(wallSign.getFacing().getOppositeFace()).setType(Materials.RED_TERRACOTTA.getType("block"));
                    }
                    sign2.setLine(3, arena.getPlayers().size() + "/" + arena.getMaxPlayers());
